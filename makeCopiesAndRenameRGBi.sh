...
cp rgb_raw_8bits/*.png rgb_iRange_100_60_8bits/
cd rgb_iRange_100_60_8bits
rename -v 's/^([0-9]{4})(.png)/i100_$1$2/' *
cd ..

cp rgb_i_90_8bits/*.png rgb_iRange_100_60_8bits/
cd rgb_iRange_100_60_8bits
rename -v 's/^([0-9]{4})(.png)/i90_$1$2/' *
cd ..

cp rgb_i_80_8bits/*.png rgb_iRange_100_60_8bits/
cd rgb_iRange_100_60_8bits
rename -v 's/^([0-9]{4})(.png)/i80_$1$2/' *
cd ..

cp rgb_i_70_8bits/*.png rgb_iRange_100_60_8bits/
cd rgb_iRange_100_60_8bits
rename -v 's/^([0-9]{4})(.png)/i70_$1$2/' *
cd ..

cp rgb_i_60_8bits/*.png rgb_iRange_100_60_8bits/
cd rgb_iRange_100_60_8bits
...
cp rgb_iRange_50_10_8bits/* rgb_iAll_8bits
cp rgb_iRange_100_60_8bits/* rgb_iAll_8bits
